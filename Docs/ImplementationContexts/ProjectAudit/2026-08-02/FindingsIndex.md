...
| AUD-010 | low | latent-bug, protocol drift | Watch command producer uses shared literal `"watch"` rather than stable per-device `watch-UUID` | `timetrackerWatchApp/WatchAppStore.swift:29` | UI-PLATFORM-002 | resolved and verified 2026-08-03 |
