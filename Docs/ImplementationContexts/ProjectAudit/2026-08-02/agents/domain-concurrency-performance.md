...
- **Trigger and suspected impact:** pressing Apply with a large uncapped workspace can block UI responsiveness and queue unrelated writes. `Docs/ImplementationContexts/2026-07-29-performance-hardening.md:187-188` independently recorded this same MainActor full-workspace risk as follow-up work.
