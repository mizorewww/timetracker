...
This context turns the confirmed findings in
`Docs/ImplementationContexts/ProjectAudit/2026-08-02/FindingsIndex.md` into
small, independently verified checkpoints. Findings are handled in risk order;
