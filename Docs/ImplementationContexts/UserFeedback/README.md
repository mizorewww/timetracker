...
- [~] 02 Today 增加本周累计时间柱状图（[实现上下文](tasks/02-today-weekly-time-chart.md)）
...
- 当前主产品任务：02 Today 本周累计时间柱状图。
- 任务 02 已有 `97021b1` 的生产实现；本轮不根据提交标题直接勾选，而是重新审查领域语义、Swift Charts/HIG、普通字号 iPhone/iPad 画面和 Release 安装。
