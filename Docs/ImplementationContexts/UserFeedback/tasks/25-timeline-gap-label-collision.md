...
- Task 25 最终 iPhone 17 Pro 复核 simulator：`9849F363-B3DC-4733-8070-19677EEFE11A`（iOS 27.0；owned，仅用于最终跨平台查询复核）。
...
- 最终复核结束后必须删除新建的 owned iPhone，并确认无 Booted device、DerivedData、xcresult 或导出截图残留；前两台 owned 设备已经删除。
