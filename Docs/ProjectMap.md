...
| `timetracker/Repositories` | SwiftData query/write implementations behind repository protocols, including rapid-restart segment/session canonicalization | Changing fetch predicates, persistence semantics, soft delete, rapid-restart tombstones, or ledger writes | UI decisions or derived analytics formulas |
