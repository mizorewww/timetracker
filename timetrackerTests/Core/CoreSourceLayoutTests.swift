...
struct CoreSourceLayoutTests {
    ...
    func sourceLayoutUsesSemanticStoreServiceFeatureAndSharedUIFolders() throws {
        ...
        let expectedFiles = [
            ...
            "timetracker/Stores/Facade/TimeTrackerStore+TaskQuantityCommands.swift",
            ...
            "timetracker/Stores/Facade/TimeTrackerStore+WatchCommands.swift",
            ...
            "timetracker/Stores/Facade/TimeTrackerStore+TaskDraftRecovery.swift",
            ...
            "timetracker/Stores/Facade/TimeTrackerStore+Timeline.swift",
            ...
            "timetracker/Stores/Domains/AnalyticsStore+ComparisonWindow.swift",
            ...
            "timetracker/Models/PersistentDatePolicy.swift",
            ...
            "timetracker/Models/AppleHealthDataModels.swift",
            ...
            "timetracker/Services/Analytics/AppleHealthTimelineProjectionService.swift",
            "timetracker/Services/Analytics/TodayActivityHeatmapSnapshotService.swift",
            "timetracker/Services/Analytics/TodayActivityHeatmapSnapshotModels.swift",
            ...
            "timetracker/Services/Checklist/StoreScopedChecklistCommandCoordinator+VisualSuggestions.swift",
            ...
            "timetracker/Services/Inbox/StoreScopedInboxCommandCoordinator+CaptureReceipts.swift",
            "timetracker/Services/Inbox/StoreScopedInboxSuggestionCommandCoordinator.swift",
            "timetracker/Services/Inbox/StoreScopedInboxMoveCommandCoordinator.swift",
            ...
            "timetracker/Services/SystemIntegration/AppleHealthTimelinePreferences.swift",
            ...
            "timetracker/Services/SystemIntegration/SyncConflictService+SnapshotSlotLocations.swift",
            "timetracker/Services/SystemIntegration/SyncConflictService+SnapshotSlots.swift",
            ...
            "timetracker/Services/SystemIntegration/SyncConflictStateManifest.swift",
            "timetracker/Services/SystemIntegration/StoreMutationBroadcaster.swift",
            "timetracker/Services/SystemIntegration/DurableLocalFile+DirectoryReading.swift",
            "timetracker/Services/SystemIntegration/DurableLocalFile+Reading.swift",
            ...
            "timetracker/Services/Tasks/TaskDraftRecoveryCodec.swift",
            ...
            "timetracker/Services/Tasks/StoreScopedTaskQuantityEntryCommandCoordinator.swift",
            "timetracker/Services/Tasks/StoreScopedTaskQuantityEntryCommandCoordinator+Mutations.swift",
            "timetracker/Services/Tasks/StoreScopedTaskQuantityEntryCommandCoordinator+Outcome.swift",
            "timetracker/Services/Tasks/StoreScopedTaskQuantityEntryCommandCoordinator+Validation.swift",
            "timetracker/Services/Tasks/TaskQuantityEntryMutationModels.swift",
            "timetracker/Services/Tasks/TaskQuantityEntryPersistenceState.swift",
            "timetracker/Services/Tasks/TaskQuantityProgressService.swift",
            ...
            "timetracker/Features/Tasks/Detail/TaskDraftRecoveryReason.swift",
    ...
    func taskEditorFilesStaySplitBySection() throws {
        ...
        let focusedFiles = [
            ...
            "RecoveredTaskEditorSheet.swift",
            "TaskDraftRecoveryCleanupSection.swift",
            ...
            "TaskQuantityEditorSection.swift",
            "TaskRecurrenceEditorSection.swift",
    ...
    func taskDetailFilesStaySplitByResponsibility() throws {
        ...
        let focusedFiles = [
            ...
            "TaskDetailWorkspace.swift",
            "TaskDetailAutosaveController.swift",
            "TaskDetailAutosaveController+Workspace.swift",
            "TaskDetailAutosaveModifier.swift",
            "TaskDetailAutosaveViews.swift",
            "TaskDetailWorkspace+Analytics.swift",
            "TaskDetailWorkspace+Autosave.swift",
            "TaskDetailWorkspace+Navigation.swift",
            "TaskDetailWorkspace+Recovery.swift",
            "TaskDetailDraftRecoveryModifier.swift",
            "TaskDraftRecoveryReason.swift",
            "TaskDetailContentView.swift",
            "TaskDetailQuantityViews.swift",
            "TaskDetailQuantityComponents.swift",
            "TaskQuantityEntryEditorModels.swift",
            "TaskQuantityEntryEditorViews.swift",
            "TaskQuantityEntryEditorActions.swift",
    ...
    func analyticsStoreFilesStaySplitByResponsibility() throws {
        ...
        let focusedFiles = [
            ...
            "AnalyticsStore+ComparisonWindow.swift",
    ...
    func analyticsFeatureFilesStaySplitByResponsibility() throws {
        ...
        let focusedFiles = [
            ...
            "AnalyticsCategoryDetailContent.swift",
            ...
            "Sections/AnalyticsFocusRoundViews.swift",
    ...
    func analyticsServiceFilesStaySplitByResponsibility() throws {
        ...
        let focusedFiles = [
            ...
            "AppleHealthTimelineProjectionService.swift",
            "TodayActivityHeatmapSnapshotService.swift",
            "TodayActivityHeatmapSnapshotModels.swift",
            "TodayActivityHeatmapSnapshotService+Indexing.swift",
            "TodayActivityHeatmapSnapshotService+MetricValues.swift",
            "TodayActivityHeatmapSnapshotService+CalendarProjection.swift",
            "AppleHealthSleepEpisodeModels.swift",
            "AppleHealthSleepEpisodeService.swift",
            "AppleHealthSleepEpisodeService+Deduplication.swift",
            "AnalyticsVisualSnapshotModels.swift",
            "AnalyticsVisualSnapshotService.swift",
            "AnalyticsVisualOverlapService.swift",
            "AnalyticsVisualOverlapService+Sweep.swift",
            "AnalyticsVisualOverlapService+Materialization.swift",
    ...
    func syncConflictFilesStaySplitByResponsibility() throws {
        ...
        let focusedFiles = [
            ...
            "SyncConflictService+SnapshotSlotLocations.swift",
            "SyncConflictService+SnapshotSlots.swift",
            "SyncConflictService+StateWriting.swift",
            "SyncConflictState.swift",
            "SyncConflictStateManifest.swift",
    ...
    func durableLocalFileInfrastructureStaysSplitByResponsibility() throws {
        ...
        let focusedFiles = [
            ...
            "DurableLocalFile+DirectoryReading.swift",
            "DurableLocalFile+Paths.swift",
            "DurableLocalFile+Reading.swift",
    ...
    func legacyDailySummaryIsExcludedFromTheCurrentSchemaAndProductionMaintenancePaths() throws {
        ...
        #expect(currentRegistry.contains("TimeTrackerSchemaV14"))
        #expect(currentRegistry.contains("TimeTrackerSchemaV13") == false)
        ...
        #expect(migrationPlan.contains("fromVersion: TimeTrackerSchemaV13.self, toVersion: TimeTrackerSchemaV14.self"))
    ...
    func projectMapDocumentsPrimaryFoldersAndEntryPoints() throws {
        ...
        let requiredFolders = [
            ...
            "`timetracker/Services/Preferences`",
        ...
        let requiredEntryPoints = [
            ...
            "Task create/edit/move/archive/restore",
