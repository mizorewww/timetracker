...
struct AccessibilitySurfaceContractTests {
    ...
    func customSelectorsExposeSelectionAndReadableColorNames() throws {
        ...
        #expect(quickStart.contains(".accessibilityAddTraits(.isSelected)"))
        #expect(quickStart.contains("quickStart.editor.available."))
        #expect(quickStart.contains("quickStart.editor.pinned."))
