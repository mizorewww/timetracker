...
struct HomeUIContractTests {
    ...
    func todayAndAnalyticsShareTheDailyTimeSeriesChart() throws {
        ...
        #expect(homeSource.contains("homeVisualizationListCard(") == false)
        #expect(homeSource.contains("homeVisualizationListSection()") == false)
        #expect(homeSource.contains(".listRowInsets(EdgeInsets())") == false)
    ...
    func todayAndAnalyticsShareOneGraphicalTimelineComponent() throws {
        ...
        #expect(sharedSource.contains("TimelineChartLayout.horizontalPlotLanes("))
        #expect(sharedSource.contains("TimelineChartLayout.verticalLanes("))
        #expect(sharedSource.contains("TimelineChartLayout.horizontalBars("))
        #expect(sharedSource.contains("TimelineChartLayout.verticalBars("))
        #expect(sharedSource.contains("TimelineChartLayout.axisTicks("))
        #expect(sharedSource.contains("tick.role.isBoundary"))
        #expect(sharedSource.contains("laneCount: barLayout.laneCount"))
        #expect(sharedSource.contains("axisLength: barLayout.axisLength"))
        #expect(sharedSource.contains("placement: placement"))
        #expect(sharedSource.contains("height: placement.axisExtent"))
        #expect(sharedSource.contains("width: placement.axisExtent"))
        #expect(sharedSource.contains("x: placement.axisOrigin"))
        #expect(sharedSource.contains("y: placement.axisOrigin"))
        #expect(sharedSource.contains("horizontalGapLabelFrame("))
        ...
        #expect(chartSource.contains("verticalAxisLabelWidth("))
        #expect(chartSource.contains("horizontalGapLine("))
        #expect(chartSource.contains("omittedGapLabel("))
    ...
    func multipleGapTimelineFixtureCoversCompactAndHorizontalCollisionLayouts() throws {
        ...
        #expect(seedSource.contains("13 * 60 * 60 + 5 * 60"))
        #expect(seedSource.contains("duration: 10 * 60"))
        #expect(seedSource.contains("15 * 60 * 60 + 50 * 60"))
        ...
        #expect(uiTestSource.contains("frame.width <= 110") == false)
        #expect(uiTestSource.contains("iphone-home-task27-intrinsic-gap-capsules"))
        #expect(uiTestSource.contains("ipad-home-task27-intrinsic-gap-capsules-portrait"))
        #expect(uiTestSource.contains("ipad-home-task27-intrinsic-gap-capsules-landscape"))
        #expect(uiTestSource.contains("mac-home-task27-intrinsic-gap-capsules"))
    }
