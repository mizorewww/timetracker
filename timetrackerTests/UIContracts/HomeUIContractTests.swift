...
struct HomeUIContractTests {
    ...
    func inboxUsesOwnDestinationAndSmoothInlineCapture() throws {
        ...
        #expect(inboxSource.contains("Section {"))
        ...
        #expect(inboxSource.contains(".listRowBackground(AppColors.cardBackground)"))
        ...
        #expect(inboxSource.contains(".buttonStyle(.plain)") == false)
        #expect(inboxSource.contains(".buttonStyle(.bordered)"))
        #expect(inboxSource.contains(".buttonBorderShape(.circle)"))
        #expect(inboxSource.contains("frame(width: isCompact ? 40 : 36"))
