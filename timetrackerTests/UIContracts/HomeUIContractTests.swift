...
struct HomeUIContractTests {
    ...
    func todayAndAnalyticsShareOneGraphicalTimelineComponent() throws {
        ...
        #expect(chartSource.contains("TimelineChartHorizontalSizingLayout("))
        #expect(chartSource.contains("horizontalGapLine("))
        #expect(chartSource.contains("horizontalGapLabel("))
        #expect(chartSource.contains("verticalGapLine("))
        #expect(chartSource.contains("verticalGapLabel("))
        #expect(gridSource.contains("TimelineChartLayout.horizontalGapLabelFrame("))
    ...
    func multipleGapTimelineFixtureCoversCompactAndHorizontalCollisionLayouts() throws {
        ...
        #expect(uiTestSource.contains("identifier BEGINSWITH %@ AND label == %@"))
        #expect(uiTestSource.contains("\"timeline.gap.\""))
        #expect(uiTestSource.contains("\"2 hr skipped\""))
